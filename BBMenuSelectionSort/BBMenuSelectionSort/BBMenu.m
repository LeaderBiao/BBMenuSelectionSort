...
#define BTableViewCellHeight 44

#define BTextColor [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1]
#define BDetailTextColor [UIColor colorWithRed:136/255.0 green:136/255.0 blue:136/255.0 alpha:1]
#define BSeparatorColor [UIColor colorWithRed:219/255.0 green:219/255.0 blue:219/255.0 alpha:1]
#define BCellBgColor [UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1]
#define BTextSelectColor [UIColor colorWithRed:246/255.0 green:79/255.0 blue:0/255.0 alpha:1]

#define BTableViewHeight 300
...
{
    BBIndexPath *path = [[self alloc] initWithColumn:column row:row];
    return path;
}
...
#pragma mark - BBSuperMenu
@interface BBMenu () <UITableViewDataSource, UITableViewDelegate>
{
    struct {
...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height
{
    ...
    if (self)
    {
        ...
        _textColor = BTextColor;
        _selectedTextColor = BTextSelectColor;
        _detailTextFont = [UIFont systemFontOfSize:11];
        _separatorColor = BSeparatorColor;
        _detailTextColor = BDetailTextColor;
        _indicatorColor = BTextColor;
        _tableViewHeight = BTableViewHeight;
        ...
        _leftTableView.rowHeight = BTableViewCellHeight;
        _leftTableView.separatorColor = BSeparatorColor;
        ...
        _rightTableView.rowHeight = BTableViewCellHeight;
        _rightTableView.separatorColor = BSeparatorColor;
        ...
        _bottomLine.backgroundColor = BSeparatorColor;
...
- (void)setDataSource:(id<BBSuperMenuDataSource>)dataSource
{
    ...
    for (int i = 0; i < _numberOfColumn; i++)
    {
        ...
        {
            titleString = [_dataSource menu:self titleForItemsInRowAtIndexPath:[BBIndexPath indexPathWithColumn:i row:0 item:0]];
        }
        else
        {
            titleString = [_dataSource menu:self titleForRowAtIndexPath:[BBIndexPath indexPathWithColumn:i row:0]];
        }
...
- (void)animateTableView:(UITableView *)tableview show:(BOOL)show complete:(complete)complete
{
    ...
    if (show)
    {
        ...
        CGFloat tableViewHeight = num * BTableViewCellHeight > BTableViewHeight ? BTableViewHeight : num * BTableViewCellHeight;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == _leftTableView)
    {
        ...
        {
            cell.textLabel.text = [_dataSource menu:self titleForRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:indexPath.row]];
            
            if (_dataSourceFlag.imageNameForRowAtIndexPath)
            {
                NSString *imgName = [_dataSource menu:self imageNameForRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:indexPath.row]];
            ...
            {
                cell.detailTextLabel.text = [_dataSource menu:self detailTextForRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:indexPath.row]];
            }
            else
            {
    ...
    else
    {
        ...
        if (_dataSourceFlag.titleForItemInRowAtIndexPath)
        {
            ...
            cell.textLabel.text = [_dataSource menu:self titleForItemsInRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:currentSelectedRow item:indexPath.row]];
            
            if (_dataSourceFlag.imageNameForItemInRowAtIndexPath)
            {
                NSString *imgName = [_dataSource menu:self imageForItemsInRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:currentSelectedRow item:indexPath.row]];
                if (imgName && imgName.length > 0)
                {
                    cell.imageView.image = [UIImage imageNamed:imgName];
                }
            ...
            {
                cell.detailTextLabel.text = [_dataSource menu:self detailTextForItemsInRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:currentSelectedRow item:indexPath.row]];
            }
            else
            {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (tableView == _leftTableView)
    {
        ...
        {
            [_delegate menu:self didSelectRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:indexPath.row]];
        }
    }
    else
    {
        ...
        {
            [_delegate menu:self didSelectRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:[_currentSelectedRows[_currentSelectedColumn] integerValue] item:indexPath.item]];
        }
    }
}
...
{
    [self selectIndexPath:[BBIndexPath indexPathWithColumn:0 row:0]];
}
...
- (void)selectIndexPath:(BBIndexPath *)indexPath
{
    ...
    if (indexPath.item < 0 )
    {
        ...
        {
            title.string = [_dataSource menu:self titleForItemsInRowAtIndexPath:[BBIndexPath indexPathWithColumn:indexPath.column row:indexPath.row]];
           
            [_delegate menu:self didSelectRowAtIndexPath:[BBIndexPath indexPathWithColumn:indexPath.column row:indexPath.row item:0]];
        }
        else
        {
            title.string = [_dataSource menu:self titleForRowAtIndexPath:[BBIndexPath indexPathWithColumn:indexPath.column row:indexPath.row]];
...
- (BOOL)setMenuWithSelectedRow:(NSInteger)row
{
    ...
    if (_dataSourceFlag.numberOfItemsInRow && [_dataSource menu:self numberOfItemsInRow:row inColumn:_currentSelectedColumn] > 0)
    {
        ...
        {
            title.string = [_dataSource menu:self titleForRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:row]];
...
- (void)setMenuWithSelectedItem:(NSInteger)item
{
    ...
    title.string = [_dataSource menu:self titleForItemsInRowAtIndexPath:[BBIndexPath indexPathWithColumn:_currentSelectedColumn row:currentSelectedMenudRow item:item]];
